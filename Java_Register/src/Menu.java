...
public class Menu implements ActionListener{
    ...
    public Menu(Integer userID) throws SQLException {
        ...
        label.setText("User ID " + sql.UserData[0][0]);
        ...
        nazwa = new JLabel();
        nazwa.setText("Zalogowano się jako " + sql.UserData[0][1]);
    ...
    public void actionPerformed(ActionEvent e) {
        ...
        if(e.getSource() == signOut){
            ...
            for(int i = 0; i < 3; i++){
                if(sql.UserData[0][i] != null){
                    sql.UserData[0][i] = null;
                }
            }
